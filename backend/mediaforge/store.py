        ...
        with self._connect() as connection:
            ...
            connection.execute(
                """UPDATE scene_recipe_tasks SET stage = 'service_restarted', updated_at = ?
                   ...
                   AND stage IN ('queued', 'validate_recipe', 'blender_recipe', 'blender_bake', 'publish_bake', 'vision_review', 'scene_refinement', 'publish_refinement', 'publish_revision', 'publish_observation', 'publish_review')""",
