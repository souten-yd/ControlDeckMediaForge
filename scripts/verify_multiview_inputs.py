...
This is an evaluation tool, not a public generation API or an adoption receipt.
It never downloads models, edits images, or infers camera calibration.
"""
    ...
    for index, frame in enumerate(frames):
        ...
        with path.open('rb') as stream:
            ...
            with Image.open(stream) as image:
                ...
                # Native conditioning premultiplies RGB by alpha. Hidden RGB must
                # not let an otherwise identical image pass the duplicate check.
