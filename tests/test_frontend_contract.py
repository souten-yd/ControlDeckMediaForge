...
def test_mobile_blender_runtime_rows_preserve_text_and_touch_controls():
...
def test_blender_session_gateway_is_private_reauthenticating_and_responsive() -> None:
    ...
    assert "/blender-rfb-loader.js" in SCRIPT
    assert 'script.crossOrigin = "use-credentials"' in SCRIPT
